...
export const inspiraImageParticles = () => {
  ...
  class InspiraImageParticle {
    ...
    _initSettings(options) {
      ...
      this.particleGap = options.particleGap * 1 || 2; // Reduced for better performance
      ...
      this.growDuration = options.growDuration * 1 || 100; // Faster animation
      this.waitDuration = options.waitDuration * 1 || 100; // Faster animation
      this.shrinkDuration = options.shrinkDuration * 1 || 100; // Faster animation
      ...
      this.lifeCycle =
        options.lifeCycle !== undefined && options.lifeCycle !== "false"
          ? !!options.lifeCycle
          : true; // Enable lifecycle for animation
      ...
      this.noise = isNaN(options.noise * 1) ? 5 : options.noise * 1; // Reduced noise
